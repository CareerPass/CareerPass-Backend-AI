...
Original file is located at
    https://colab.research.google.com/drive/1ZfWBgXlHP2G6rxdntjcHEBAkLNtQr9jG
"""
...
# FastAPI 애플리케이션 초기화
app = FastAPI(
    title="B Team Interview Analysis API",
    description="면접 답변 텍스트를 받아 LLM으로 분석하고 피드백을 제공합니다."
)
...
# ==============================================================================
# 4. FastAPI 엔드포인트 정의 (A팀이 호출할 API)
# ==============================================================================

@app.post("/analysis/interview/run", response_model=AnswerAnalysisResult)
async def analyze_interview_answer(dispatch_data: AnswerDispatch):
    """
    HTTP POST 요청을 받아 면접 답변 분석을 실행하는 B팀의 메인 엔드포인트입니다.
    """
